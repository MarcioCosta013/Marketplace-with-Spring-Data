package marcio.marketplace.catalog.application;

import marcio.marketplace.catalog.application.dto.EventOutput;
import marcio.marketplace.catalog.domain.Event;
import marcio.marketplace.catalog.domain.EventMetadataRepository;
...
public class BrowseShowcaseUseCase {
    ...
    public List<EventOutput> execute(){
        ...
        var events = futures.stream()
                .map(CompletableFuture::join) //para executar tudo e rodar em paralelo
