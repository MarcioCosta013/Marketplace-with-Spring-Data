package marcio.marketplace.catalog;
...
@EnableJpaRepositories( //tudo isso basicamente para separar o que vai para cada DB.
        basePackages = "marcio.marketplace.catalog",
...
public class CatalogConfiguration {
    ...
    @Qualifier("catalog")
    @Bean(defaultCandidate = false) //diz que esse bean nao e o primario...
    @ConfigurationProperties("catalog.datasource")
    public DataSourceProperties catalogDataSourceProperties(){
        return new DataSourceProperties();
    }

    @Qualifier("catalog") //Serve para o spring identificar qual DataSourceProperties ele deve injetar, quando tem muitos DBs...
    @Bean(defaultCandidate = false) //Quando não tem o 'Qualifier' o spring jhá carrega o 'Primary'...
    ...
    public LocalContainerEntityManagerFactoryBean catalogEntityManagerFactory(@Qualifier("catalog") DataSource dataSource,
        ...
        return builder
                ...
                .packages("marcio.marketplace.catalog")
    ...
    public RedisCacheManager catalogCacheManager(RedisConnectionFactory connectionFactory){
        return RedisCacheManager.builder(connectionFactory).build(); // conexao com o redis. faz conexao automatica...
    }
