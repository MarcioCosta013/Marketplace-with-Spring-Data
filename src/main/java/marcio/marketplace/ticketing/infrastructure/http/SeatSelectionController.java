package marcio.marketplace.ticketing.infrastructure.http;

import marcio.marketplace.ticketing.application.SelectSeatUseCase;
import marcio.marketplace.ticketing.domain.CustomerId;
import marcio.marketplace.ticketing.domain.EventId;
import marcio.marketplace.ticketing.infrastructure.http.request.SeatSelectionRequest;
